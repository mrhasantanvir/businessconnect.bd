               ...
               <div className="flex flex-col gap-4">
                  ...
                  <div className="relative">
                     ...
                     <input 
                       ...
                       className="w-full bg-gray-50 border border-gray-100 rounded-none pl-10 pr-4 py-2.5 text-[11px] font-bold outline-none focus:bg-white focus:border-indigo-600 transition-all placeholder:text-gray-300"
                       value={staffSearch}
                       onChange={(e) => setStaffSearch(e.target.value)}
                       autoFocus
                     />
                  </div>
                  <div className="max-h-40 overflow-y-auto no-scrollbar border-t border-gray-50 pt-3 space-y-1">
                     {filteredStaff.map(s => (
                        <button 
                          key={s.id} 
                          type="button"
