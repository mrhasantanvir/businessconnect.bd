    ...
    return (
      <div className="max-w-md w-full bg-white border border-gray-100 rounded-[4px] p-8 text-center space-y-6 shadow-sm animate-in fade-in zoom-in duration-300">
         ...
         <button
           ...
           className="w-full inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-500 hover:text-red-600 hover:bg-red-50 border border-gray-200 hover:border-red-200 rounded-[4px] transition-all duration-200"
         >
