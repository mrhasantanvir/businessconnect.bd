    ...
    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
         <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50  rounded-full">
               ...
               <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">Financial Integrity System</span>
            </div>
      ...
      <div className="bg-indigo-50  border border-indigo-100  rounded-[40px] p-10 flex items-center justify-between relative overflow-hidden group">
         ...
         <div className="flex items-center gap-8 relative z-10">
            ...
            <div>
               <h3 className="text-xl font-bold text-indigo-900  uppercase tracking-tight">Consolidated Settlement</h3>
         ...
         <button className="px-8 py-4 bg-white text-slate-900 text-slate-900 text-slate-900 border border-slate-100 text-white rounded-2xl text-[10px] font-bold uppercase tracking-widest hover:bg-black transition-all shadow-xl relative z-10">
            View History
         </button>
      </div>
