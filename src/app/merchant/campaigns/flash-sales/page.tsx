      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-3xl font-black tracking-tighter text-slate-900  uppercase">Flash <span className="text-amber-500">Discounts</span></h1>
          </div>
        ...
        <button 
          ...
          className="group flex items-center gap-3 px-8 py-4 bg-slate-900  text-white  rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-2xl"
        >
            ...
            <table className="w-full">
               <thead>
                  <tr className="bg-slate-50/50 ">
                     <th className="px-10 py-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Campaign Identity</th>
                     <th className="px-10 py-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Temporal Window</th>
                     <th className="px-10 py-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Performance</th>
            ...
            <div className="w-full max-w-sm aspect-[4/5] bg-white rounded-[40px] shadow-2xl p-2 relative group overflow-hidden">
               <div className="w-full h-full rounded-[36px] bg-slate-50 overflow-hidden flex flex-col">
                  <div className="h-48 bg-slate-200 relative">
                     <div className="absolute top-4 left-4 px-4 py-2 bg-red-600 text-white text-[10px] font-black uppercase rounded-lg shadow-xl">65% OFF</div>
                        ...
                        <div className="flex gap-2 justify-center">
                           {["02", "14", "55", "12"].map((n, i) => (
                              <div key={i} className="w-10 h-10 bg-white/90 rounded-lg flex items-center justify-center flex-col shadow-lg">
                                 <span className="text-xs font-black text-slate-900 leading-none">{n}</span>
                  ...
                  <div className="p-6 space-y-4">
                     ...
                     <div className="space-y-1.5">
                        <div className="flex justify-between text-[8px] font-black uppercase text-slate-500 tracking-widest"><span>Sold: 420</span> <span>Only 80 Left</span></div>
