      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 p-20 flex-col justify-between relative overflow-hidden">
         ...
         <div className="relative z-10 space-y-8">
            <div className="p-8 bg-white/5 backdrop-blur-xl rounded-[40px] border border-white/10 space-y-4">
               <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-indigo-400">Privileged Access</p>
               <h4 className="text-xl font-bold text-white uppercase">Instant Reward Points</h4>
            ...
            <div className="flex items-center gap-4 text-white/20">
               ...
               <span className="text-[10px] font-bold uppercase tracking-widest">Secure Data Encryption</span>
            </div>
         </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center p-8 lg:px-20 py-20 relative overflow-y-auto">
         ...
         <div className="max-w-md mx-auto w-full space-y-12 animate-in fade-in slide-in-from-right-20 duration-1000">
            <div className="space-y-4">
               <h2 className="text-2xl font-bold tracking-tight uppercase leading-none">Create <span className="text-indigo-600">Account</span></h2>
               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Join thousands of happy customers today.</p>
            </div>

            {error && (
              <div className="p-4 bg-red-50 text-red-600 rounded-2xl text-[10px] font-bold uppercase tracking-widest border border-red-100">
                 {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               <div className="space-y-4">
                  <div className="group space-y-2">
                     <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Full Legal Name</label>
                  ...
                  <div className="group space-y-2">
                     <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Phone Number</label>
                     <div className="flex items-center gap-4 bg-white border border-slate-100 p-5 rounded-[24px] focus-within:border-indigo-600 focus-within:shadow-2xl focus-within:shadow-indigo-600/5 transition-all">
                  ...
                  <div className="group space-y-2">
                     <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-4 group-focus-within:text-indigo-600 transition-colors">Security Password</label>
                     <div className="flex items-center gap-4 bg-white border border-slate-100 p-5 rounded-[24px] focus-within:border-indigo-600 focus-within:shadow-2xl focus-within:shadow-indigo-600/5 transition-all">
               ...
               <button 
                  type="submit" 
                  disabled={loading}
                  className="w-full py-6 bg-indigo-600 text-white rounded-[32px] text-xs font-bold uppercase tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-slate-900 transition-all shadow-2xl hover:scale-105 disabled:opacity-50"
               >
            ...
            <div className="pt-8 text-center space-y-4 border-t border-slate-100">
               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Already have an account?</p>
               <Link href={`/s/${params.slug}/login`} className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-900 hover:gap-4 transition-all">
