  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 space-y-10 animate-in fade-in duration-700">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight uppercase">Performance Hub</h1>
      ...
      <div className="bg-slate-900 rounded-[48px] p-12 text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 space-y-6 max-w-xl">
           <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500 rounded-full text-[10px] font-bold uppercase tracking-widest">
              <TrendingUp className="w-4 h-4" /> Coming Soon
           </div>
           <h2 className="text-2xl font-bold tracking-tight uppercase leading-none">Advanced Neural <span className="text-emerald-500">Analytics</span></h2>
